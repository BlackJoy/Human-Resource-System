  ...
  <body>
    ...
    <table border="0" width="100%" style="background: rgb(240, 240, 240); font-size: 12px;" cellpadding="0" cellspacing="2">
    	<tr>
    		...
    		<td width="25%"><s:property value="#request.curr_yingpin.NAME"/></td>
    		<td width="15%" align="right"><span style="color:red;">*</span>性别：</td>
    		<td><s:if test="#request.curr_yingpin.GENDER == 0">女</s:if><s:else>男</s:else></td>
    	</tr>
    	<tr>
    		<td align="right"><span style="color:red;">*</span>身份证：</td>
    		<td><s:property value="#request.curr_yingpin.IDENTITYCARD"/></td>
    		<td align="right"><span style="color:red;">*</span>学历：</td>
    		<td><s:property value="#request.curr_yingpin.EDU"/></td>
    	</tr>
    	<tr>
    		<td align="right"><span style="color:red;">*</span>专业：</td>
    		<td><s:property value="#request.curr_yingpin.SPECIALTY"/></td>
    		<td align="right"><span style="color:red;">*</span>毕业院校：</td>
    		<td><s:property value="#request.curr_yingpin.GRADUATESCHOOL"/></td>
    	</tr>
    	<tr>
    		<td align="right"><span style="color:red;">*</span>地址：</td>
    		<td><s:property value="#request.curr_yingpin.ADDRESS"/></td>
    		<td align="right"><span style="color:red;">*</span>联系电话：</td>
    		<td><s:property value="#request.curr_yingpin.PHONE"/></td>
    	</tr>
    	<tr>
    		<td align="right"><span style="color:red;">*</span>所属组织：</td>
    		<td><s:property value="#request.curr_yingpin.ORGSHORTNAME"/></td>
    		<td align="right"><span style="color:red;">*</span>应聘职位：</td>
    		<td><s:property value="#request.curr_yingpin.PO"/></td>
    	</tr>
    	<tr>
    		<td align="right"><span style="color:red;">*</span>应聘时间：</td>
    		<td><s:property value="#request.curr_yingpin.YPT"/></td>
    		<td>&nbsp;</td>
    		<td>&nbsp;</td>
    	</tr>
    </table>
