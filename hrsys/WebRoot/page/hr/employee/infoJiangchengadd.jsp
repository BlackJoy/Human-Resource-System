...
<html>
  ...
  <body>
    ...
    <form id="accountAddForm" action="employee_AddJiangcheng.action" method="post">
    ...
    <table border="0" width="100%" style="background: rgb(240, 240, 240); font-size: 12px;" cellpadding="0" cellspacing="2">
      <input type="hidden" id="empid" name="jiangcheng.empid" value="<s:property value='employeeId'/>" />
    	
    	<tr height="30px;">
    		<td width="15%" align="right"><span style="color:red;">*</span>员工姓名：</td>
    		<td width="30%"><input type="text" name="jiangcheng.empname" id="empname" value="<s:property value='#request.emp.employeeName'/>" /></td>
    		<td width="15%" align="right">&nbsp;</td>
    		<td width="20%">&nbsp;</td>
    		<td width="20%">&nbsp;</td>
    	</tr>
    	<tr height="30px;">
    		<td align="right"><span style="color:red;">*</span>奖惩原因：</td>
    		<td><input type="text" name="jiangcheng.reason" id="reason" /></td>
        ...
        <!-- 选择日期 -->
    		...
    		<tr height="30px;">
    		<td align="right"><span style="color:red;">*</span>奖惩措施：</td>
    		<td><input type="text" name="jiangcheng.cuoshi" id="cuoshi" /></td>
    	</tr>
