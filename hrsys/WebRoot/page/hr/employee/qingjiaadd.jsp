...
<html>
  ...
  <body>
  	...
  	<form id="yingpinAddForm" action="employ_doAddYingPin.action" method="post">
    ...
    <table border="0" width="100%" style="background: rgb(240, 240, 240); font-size: 12px;" cellpadding="0" cellspacing="2">
    	<tr>
    		...
    		<td width="25%"><input type="text" name="employ.name" id="employname" /></td>
    	...
    	<tr>
    		...
    		<td><input type="text" name="employ.identityCard" id="identityCard" /></td>
    		<td align="right"><span style="color:red;">*</span>学历：</td>
    		<td><ct:dicDataSelectTag name="employ.education" typeCode="hr_002" /></td>
    	</tr>
    	<tr>
    		<td align="right"><span style="color:red;">*</span>专业：</td>
    		<td><input type="text" name="employ.specialty" id="specialty" /></td>
    		<td align="right"><span style="color:red;">*</span>毕业院校：</td>
    		<td><input type="text" name="employ.graduateSchool" id="graduateSchool" /></td>
    	</tr>
    	<tr>
    		<td align="right"><span style="color:red;">*</span>地址：</td>
    		<td><input type="text" name="employ.address" id="address" /></td>
    		<td align="right"><span style="color:red;">*</span>联系电话：</td>
    		<td><input type="text" name="employ.phone" id="phone" /></td>
    	</tr>
    	<tr>
    		<td align="right"><span style="color:red;">*</span>所属组织：</td>
    		<td><input type="text" name="orgname" id="orgname" disabled="disabled" value='<s:property value="#request.curr_org.orgShortName"/>' /></td>
    		<td align="right"><span style="color:red;">*</span>应聘职位：</td>
    		<td><ct:dicDataSelectTag name="employ.position" typeCode="hr_003" /></td>
    	</tr>
    	<tr>
    		<td align="right"><span style="color:red;">*</span>应聘时间：</td>
    		<td><input type="text" name="employ.yingpinTime" id="yingpinTime" onfocus="setday(this)" /></td>
    		<td><input type="hidden" name="employ.employStatus" id="employStatus" value="1" /></td>
    		<td>&nbsp;</td>
    	</tr>
    </table>
    </form>
