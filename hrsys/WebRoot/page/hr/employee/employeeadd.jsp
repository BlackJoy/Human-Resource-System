...
<html>
  ...
  <body>
    ...
    <form id="accountAddForm" action="employee_add.action" method="post">
    ...
    <table border="0" width="100%" style="background: rgb(240, 240, 240); font-size: 12px;" cellpadding="0" cellspacing="2">
    	<tr height="30px;">
    		...
    		<td width="30%"><input type="text" name="emp.employeeCode" id="employeeCode" /></td>
    	...
    	<tr height="30px;">
    		...
    		<td><input type="text" name="emp.employeeName" id="employeeName" /></td>
		...
		<!-- 弹出框选择部门 end-->	
    		...
    		<td>
    			<input type="radio" name="emp.gender" value="0" />男&nbsp;&nbsp;
    			<input type="radio" name="emp.gender" checked="checked" value="1" />女
    		</td>
    		
    		<td align="right"><span style="color:red;">*</span>身份证：</td>
    	    <td><input type="text" name="emp.identityCard" id="identityCard" /></td>
    		<td>&nbsp;</td>
    	</tr>
    		<tr height="30px;">
    		<td align="right"><span style="color:red;">*</span>学历：</td>
    		<td><input type="text" name="emp.education" id="education" /></td>
    		<td align="right"><span style="color:red;">*</span>专业：</td>
    		
    		<td><input type="text" name="emp.specialty" id="specialty" /></td>
    		 
    		<td>&nbsp;</td>
    	</tr>
    		<tr height="30px;">
    		<td align="right"><span style="color:red;">*</span>毕业院校：</td>
    		<td><input type="text" name="emp.graduateSchool" id="graduateSchool" /></td>
    		<td align="right"><span style="color:red;">*</span>住址：</td>
    		<td><input type="text" name="emp.address" id="address" /></td>
    		<td>&nbsp;</td>
    	</tr>
    		<tr height="30px;">
    		<td align="right"><span style="color:red;">*</span>电话：</td>
    		<td><input type="text" name="emp.phone" id="phone" /></td>
...
<!-- 选择日期 -->
    	...
    	<tr>	
    		...
    		<td><s:select labelposition="right" label="员工状态" name="emp.employeeStatus" id="employeeStatus" list="#{2:'试用',3:'待入职',4:'入职审批中',5:'在岗',6:'借调中'}"  listKey="key" listValue="value"  /></td>
    		<td>&nbsp;</td>
    	</tr>
