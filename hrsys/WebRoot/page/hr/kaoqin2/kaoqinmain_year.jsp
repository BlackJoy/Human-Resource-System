...
<html>
  ...
  <frameset id="accountFrame" rows="26,*" frameborder="0" border="0px" scrolling="NO">
	  ...
	  <frameset id="accountFrame" cols="155,*" bordercolor="rgb(191, 219, 255)" frameborder="1" border="10px" scrolling="NO">
	  	<frame name="orgFrame" src="org_listByDtreeShowPara.action?para1=kaoqinyear_list" noresize="" scrolling="auto">
	  	<frame name="zhangtaoOpFrame" src="kaoqinyear_list.action" noresize="" scrolling="NO">
	  </frameset>
