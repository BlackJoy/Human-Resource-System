...
<html>
  <head>
    ...
    <title>My JSP 'account-top.jsp.jsp' starting page</title>
    	...
    	<tr>
    		...
    		<table border="0" cellpadding="0" cellspacing="0">
    			<tr>
		    		...
		    		<td height="26px" style="background: url(images/yq_bg.gif) repeat-x; font-size:12px; font-weight: bold; color:#333;">&nbsp;缴费比例管理&nbsp;</td>
