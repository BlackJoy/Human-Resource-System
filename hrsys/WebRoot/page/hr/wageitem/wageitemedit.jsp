...
<body>
	...
	<form id="wageItemEditForm" action="wageItem_edit.action"
		method="post">
...
<input type="hidden" name="wageItem.wageId"
					id="wageId" value='<s:property value="wageItem.wageId"/>' />
		<table border="0" width="100%"
			...
			<tr height="30px;">
				...
				<td width="30%"><input type="text" name="wageItem.wageName"
					id="wageName" readonly value='<s:property value="wageItem.wageName"/>' /></td>
				<td width="15%" align="right"><span style="color: red;">*</span>工资项编码：</td>
				<td width="30%"><input type="text" name="wageItem.wageNo"
					id="wageNo" readonly value='<s:property value="wageItem.wageNo"/>' /></td>
				<td width="10%">&nbsp;</td>
			</tr>
			...
			<tr height="30px;">
				...
				<tr height="30px;">
				<td width="15%" align="right"><span style="color: red;">*</span>所属的帐套名称：</td>
				<td width="30%"><s:select list="#request.wageitemztlist" name="list1" listKey="wageTypeNo" listValue="wageTypeName" theme="simple"></s:select></td>
				<td width="15%" align="right"><span style="color: red;">*</span>选择添加到的帐套：</td>
				<td width="30%"><s:select list="#request.subztlist" name="choosezt" listKey="wageTypeId" listValue="wageTypeName" theme="simple"></s:select></td>
