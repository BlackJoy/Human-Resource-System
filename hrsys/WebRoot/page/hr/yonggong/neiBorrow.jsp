...
<html>
  ...
  <body>
    ...
    <form id="accountAddForm" action="yonggong_NeiBorrow.action" method="post">
    ...
    <table border="0" width="100%" style="background: rgb(240, 240, 240); font-size: 12px;" cellpadding="0" cellspacing="2">
      <input type="hidden" id="diao_empid" name="neiborrow.empid" value="<s:property value="#request.emp.id"/>" />   	
      <input type="hidden" id="diao_isfanhui" name="neiborrow.isfanhui" value="未返回" />   	      
      <input type="hidden" id="diao_fromorgid" name="neiborrow.fromorgid" value="<s:property value="#request.emp.orgid"/>" />   	
      <input type="hidden" id="diao_orgId" name="neiborrow.toorgid" value=""/>    
          
    		<tr height="30px;">
    		<td width="15%" align="right"><span style="color:red;">*</span>员工姓名：</td>
    		<td width="30%"><input type="text" name="neiborrow.empname" id="diao_empname" value="<s:property value="#request.emp.employeeName"/>"/></td>
		...
		<div
			...
			<input type="text"
				name="neiborrow.starttime" id="starttime" />
		</div>
		...
		<div
			...
			<input type="text"
				name="neiborrow.endtime" id="endtime" />
		</div>
    	...
    	<tr height="30px;">
    		...
    		<td><input type="text" name="neiborrow.education" id="education" value="<s:property value="#request.emp.education"/>"/></td>
		...
		<!-- 弹出框选择部门 end-->	
 		...
 		<td align="right"><span style="color:red;">*</span>职称等级：</td>
    	    <td><input type="text" name="neiborrow.zhichengdj" id="zhichengdj" /></td>
		...
		<div
			...
			<input type="text"
				name="neiborrow.pingdingtime" id="pingdingtime" />
		</div>
        ...
        <!-- 选择日期 -->
    		...
    		<td><input type="text" name="neiborrow.duzifei" id="duzifei" /></td>
    		<td align="right"><span style="color:red;">*</span>社保基数：</td>
    		
    		<td><input type="text" name="neiborrow.shebaojishu" id="shebaojishu" /></td>
    		 
    		<td>&nbsp;</td>
    	</tr>
    		<tr height="30px;">
    		<td align="right"><span style="color:red;">*</span>住房公积金：</td>
    		<td><input type="text" name="neiborrow.gongjijin" id="gongjijin" /></td>
    		<td align="right"><span style="color:red;">*</span>调动理由：</td>
    		<td><input type="text" name="neiborrow.reason" id="reason" /></td>
    		<td>&nbsp;</td>
    	</tr>
    		<tr height="30px;">
    		<td align="right"><span style="color:red;">*</span>备注：</td>
    		<td><input type="text" name="neiborrow.content" id="content" /></td>
