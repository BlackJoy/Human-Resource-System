	...
	<script type="text/javascript" language="javascript">
		...
		$(document).ready(function(){
			$("#btn_return").click(function(){
				self.location.href="<%=basePath%>approve_backlogApprove.action?eid=<s:property value="#session.curr_employee.id" />";
			});
    	...
    	<tr>
    		...
    		<table border="0" cellpadding="0" cellspacing="0">
    			<tr>
		    		...
		    		<td height="26px" style="background: url(images/yq_bg.gif) repeat-x; font-size:12px; font-weight: bold; color:#333;">&nbsp;项目审批&nbsp;</td>
