...
<html>
  ...
  <body>
  	...
  	<form id="dicDataUpdateForm" action="dic_updateData.action" method="post">
  	<input id="dicDataId" name="dicData.id" type="hidden" value="<s:property value="#request.currDicData.id" />" />
  	<input id="dicTypeId" name="dicData.dicTypeId" type="hidden" value="<s:property value="#request.currDicData.dicTypeId" />" />
  	<input id="dicTypeId" name="dicTypeId" type="hidden" value="<s:property value="#request.currDicData.dicTypeId" />" />
    ...
    <table border="0" width="100%" style="background: rgb(240, 240, 240); font-size: 12px;" cellpadding="0" cellspacing="2">
    	<tr>
    		...
    		<td><input type="text" name="dicData.dicDataCode" id="dicDataCode" value="<s:property value="#request.currDicData.dicDataCode" />" /></td>
    	</tr>
    	<tr>
    		<td width="30%" align="right"><span style="color:red;">*</span>字典数据名：</td>
    		<td><input type="text" name="dicData.dicDataName" id="dicDataName" value="<s:property value="#request.currDicData.dicDataName" />" /></td>
    	</tr>
    	<tr>
    		<td width="30%" align="right">备注：</td>
    		<td><textarea name="dicData.dicDataComment" cols="70" rows="3"><s:property value="#request.currDicData.dicDataComment" /></textarea></td>
    	</tr>
    </table>
    </form>
  </body>
