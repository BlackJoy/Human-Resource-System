...
<html>
  ...
  <body>
  	...
  	<form id="dicTypeAddForm" action="dic_addType.action" method="post">
    ...
    <table border="0" width="100%" style="background: rgb(240, 240, 240); font-size: 12px;" cellpadding="0" cellspacing="2">
    	<tr>
    		...
    		<td><input type="text" name="dicType.dicTypeCode" id="dicTypeCode" /></td>
    	</tr>
    	<tr>
    		<td width="30%" align="right"><span style="color:red;">*</span>字典类型名：</td>
    		<td><input type="text" name="dicType.dicTypeName" id="dicTypeName" /></td>
    	</tr>
    	<tr>
    		<td width="30%" align="right">备注：</td>
    		<td><textarea name="dicType.dicTypeComment" cols="70" rows="3"></textarea></td>
    	</tr>
    </table>
    </form>
  </body>
