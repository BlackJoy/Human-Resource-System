...
<html>
  ...
  <body>
  	<s:if test="#request.roleUpdate == true">
  		<script type="text/javascript" language="javascript">
  		alert("保存成功");
  		</script>
  	</s:if>
    ...
    <form id="roleUpdateForm" action="role_update.action" method="post">
    ...
    <table border="0" width="100%" style="background: rgb(240, 240, 240); font-size: 12px;" cellpadding="0" cellspacing="2">
    	<tr>
    		<td width="30%" align="right"><span style="color:red;">*</span>角色名：</td>
    		<td><input type="text" name="role.rolename" id="rolename" value="<s:property value='role.rolename'/>" /></td>
    	</tr>
    	<tr>
    		<td width="30%" align="right">角色描述：</td>
    		<td><textarea name="role.roledesc" cols="70" rows="3"><s:property value='role.roledesc'/></textarea></td>
    	</tr>
    </table>
    </form>
  </body>
