...
<html>
  ...
  <body>
    	...
    	<tr>
    		...
    		<td width="22%" align="center" valign="middle" style="color:red;">
    			...
    			<ul style="text-align: left; padding-left: 18px;">
    				...
    				<li style="list-style-type: disc;">双击“角色包含的员工”列表项可删除员工</li>
    			</ul>
    		</td>
    		<td width="39%" align="left" valign="middle" ><div style="color:red; width: 300px; text-align: center; font-size: 14px; font-weight: bold; padding-bottom:10px;">角色包含的员工</div>
    ...
    <form id="assignempForm" action="role_assignemp.action" method="post">
