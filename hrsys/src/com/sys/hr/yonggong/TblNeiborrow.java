...
/**
 * TblNeiborrow entity. @author MyEclipse Persistence Tools
 */

public class TblNeiborrow implements java.io.Serializable {
	...
	/** full constructor */
	public TblNeiborrow(String empid, String empname, String fromorgid,
			String toorgid, Date starttime, Date endtime, String education,
			String zhichengdj, String pingdingtime, String duzifei,
			String shebaojishu, String gongjijin, String reason, Date time,
			String isfanhui, String content) {
		this.empid = empid;
